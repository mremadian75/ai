...
final class VES_AI_Usage_Tracker {
    ...
    private static function record_unsafe(array $args): int {
        ...
        // Telemetry honesty: a model-derived figure is only an "actual" cost when the
        // price is CONFIRMED ('known'); approximate prices are reported as estimates.
        ...
        // completed call, else 0 (failed/estimated rows never fake an actual cost).
