    ...
    public function enqueue_assets()
    {
        ...
        wp_localize_script('fbaia-board', 'FBAIABoard', [
            ...
            'i18n'          => [
                ...
                'approve'   => __('Approve & apply', 'fluent-boards-ai-automation'),
                'reject'    => __('Reject', 'fluent-boards-ai-automation'),
                'applying'  => __('Applying…', 'fluent-boards-ai-automation'),
                'rejecting' => __('Rejecting…', 'fluent-boards-ai-automation'),
                'applied'   => __('Approved & applied ✓', 'fluent-boards-ai-automation'),
                'rejected'  => __('Rejected', 'fluent-boards-ai-automation'),
                'rejectPrompt' => __('Why reject? (optional)', 'fluent-boards-ai-automation'),
                'detected'  => __('Detected task', 'fluent-boards-ai-automation'),
