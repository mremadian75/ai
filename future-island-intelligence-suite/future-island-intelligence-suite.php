...
// Load low-level helper/polyfill functions before any class file can execute code paths
// that call mb_* functions on hosts without the mbstring extension.
require_once FIS_PLUGIN_DIR . 'includes/class-ves-string-compat.php';

// -----------------------------------------------------------------------
// VES Core bootstrap — exact same load order as the standalone Core plugin
// -----------------------------------------------------------------------
$fis_ves_files = [
    FIS_PLUGIN_DIR . 'includes/class-ves-string-compat.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-config.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-secret-redactor.php',
    ...
    FIS_PLUGIN_DIR . 'includes/class-ves-workspace-membership-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-workspace-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-permission-service.php',
    ...
    FIS_PLUGIN_DIR . 'includes/class-ves-run-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-run-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-decision-edge-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-decision-edge-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-usage-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-brief-os-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-playbook-input-validator.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-draft-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-review-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-command-room-action-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-decision-report-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-brand-market-xray-playbook.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-social-signal-mapper.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-social-signal-intelligence-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-aeo-action-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-contract-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-settings-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-replay-guard.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-rate-limit-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-callback-auth-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-result-validator.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-creative-taxonomy-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-ingestion-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-result-mapper.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-run-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-workspace-onboarding-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-provider-admin-page.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-run-diagnostics-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-operator-qa-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-private-beta-readiness-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-canonical-rest-controller.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-outcome-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-outcome-service.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-pattern-observation-store.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-pattern-observation-service.php',
...
$fis_module_files = [
    ...
    FIS_PLUGIN_DIR . 'includes/modules/command-room/class-fi-command-room-service.php',
    FIS_PLUGIN_DIR . 'includes/modules/command-room/class-fi-command-room-renderer.php',
    FIS_PLUGIN_DIR . 'includes/modules/command-room/class-fi-command-room-module.php',
