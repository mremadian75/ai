...
final class VES_Plugin {
    ...
    public static function boot() {
        ...
        if (class_exists('VES_Canonical_REST_Controller')) {
            VES_Canonical_REST_Controller::register();
        }
        if (is_admin() && class_exists('VES_Provider_Admin_Page')) {
            VES_Provider_Admin_Page::register();
        }
        if (is_admin() && class_exists('VES_Private_Beta_Readiness_Service')) {
            VES_Private_Beta_Readiness_Service::register();
        }
        if (is_admin() && class_exists('VES_Workspace_Onboarding_Service')) {
            VES_Workspace_Onboarding_Service::register();
        }
    ...
    public static function activate() {
        ...
        if (class_exists('VES_Provider_Ingestion_Store')) {
            VES_Provider_Ingestion_Store::create_table();
        }
        ...
        foreach (['VES_Run_Store', 'VES_Decision_Edge_Store', 'VES_Outcome_Store', 'VES_Pattern_Observation_Store', 'VES_Provider_Ingestion_Store'] as $fi_spine_store) {
            if (class_exists($fi_spine_store) && method_exists($fi_spine_store, 'create_table')) {
                $fi_spine_store::create_table(true);
            }
        }
        if (class_exists('VES_Run_Store')) {
            VES_Run_Store::create_table();
        }
        if (class_exists('VES_Decision_Edge_Store')) {
            VES_Decision_Edge_Store::create_table();
        }
        if (class_exists('VES_Outcome_Service')) {
            VES_Outcome_Service::create_table();
        }
        if (class_exists('VES_Pattern_Observation_Service')) {
            VES_Pattern_Observation_Service::create_table();
        }
