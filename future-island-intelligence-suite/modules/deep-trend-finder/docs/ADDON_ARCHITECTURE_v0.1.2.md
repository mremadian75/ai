...
v0.2.0 should focus on provider bridge integration, async through an approved external orchestrator, dedicated sidecar, simulator, managed worker, or optional n8n example that posts back through the ingest endpoint. Do not run heavy scraping synchronously inside WordPress.
