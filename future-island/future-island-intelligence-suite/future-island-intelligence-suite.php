...
$fis_ves_files = [
    ...
    FIS_PLUGIN_DIR . 'includes/class-ves-pilot-feedback.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-pilot-seed.php',
    FIS_PLUGIN_DIR . 'includes/class-ves-pilot-readiness.php',
