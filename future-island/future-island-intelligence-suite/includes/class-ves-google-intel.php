...
final class VES_Google_Intel {
    ...
    public static function run_actor_with_slug($actor_slug, $input, $wait_for_finish = 45) {
        ...
        // SECURITY/BUGFIX: do NOT put the Apify token in the URL query string — it
        // leaks into access/proxy logs and, sent alongside the Authorization: Bearer
        // header that VES_Apify_Client::request() injects, can trigger a 403
        // (FI-600000). Auth is handled exclusively via the header in request().
        $query = [
