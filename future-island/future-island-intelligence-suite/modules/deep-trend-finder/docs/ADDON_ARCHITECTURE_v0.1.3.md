...
The next release should connect a single async provider pathway first, preferably n8n or an external bridge that calls WordPress back through the ingest endpoint. It should not turn WordPress into the heavy scraping runtime.
