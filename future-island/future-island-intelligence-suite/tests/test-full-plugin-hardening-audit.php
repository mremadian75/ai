...
$assert(strpos($main, 'Version: 1.2.6') !== false, 'Plugin header version is 1.1.0');
$assert(strpos($main, "VES_PLUGIN_VERSION',         '1.2.6'") !== false, 'VES_PLUGIN_VERSION constant is 1.1.0');
