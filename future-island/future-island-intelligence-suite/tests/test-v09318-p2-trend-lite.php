...
$assert(strpos($main, 'Version: 1.2.6') !== false, 'plugin version bumped to p2 trend lite');
$assert(strpos($main, "VES_PLUGIN_VERSION',         '1.2.6'") !== false, 'VES_PLUGIN_VERSION bumped to p2 trend lite');
