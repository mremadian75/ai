...
$assert(strpos($main, 'Version: 1.4.1') !== false, 'plugin header bumped to p3 demo hardening');
$assert(strpos($main, "VES_PLUGIN_VERSION',         '1.4.1'") !== false, 'VES_PLUGIN_VERSION bumped to p3 demo hardening');
