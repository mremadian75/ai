...
$assert(strpos($main, 'Version: 1.2.9') !== false, 'plugin header bumped to p3 demo hardening');
$assert(strpos($main, "VES_PLUGIN_VERSION',         '1.2.9'") !== false, 'VES_PLUGIN_VERSION bumped to p3 demo hardening');
