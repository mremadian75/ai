...
class Mahan_Admin {
	...
	public static function init() {
		...
		add_action( 'admin_post_mahan_export_activity', array( 'Mahan_Analytics', 'export_activity_csv' ) );
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'    => array(
					...
					'multiple_choice' => __( 'Multiple choice', 'mahan-academy' ),
					'multi_select'    => __( 'Select all that apply', 'mahan-academy' ),
					'correctAll'      => __( 'Correct (tick every one)', 'mahan-academy' ),
					'explain'         => __( 'Explanation', 'mahan-academy' ),
					'explainPh'       => __( 'Why this is the answer — shown after grading', 'mahan-academy' ),
					'true_false'      => __( 'True / False', 'mahan-academy' ),
					'fill_blank'      => __( 'Fill in the blank', 'mahan-academy' ),
